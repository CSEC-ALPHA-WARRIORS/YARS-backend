...
| EditCourse         | PUT          | { Authorization: `Bearer ${token}` } | Param: { id }                                                                              | [ <a href="#course">Course ]                                                                                | /course/edit                 |
...
| RemoveStudent      | DELETE          | { Authorization: `Bearer ${token}` } | Param: { id }                                                                        |    { integer (1 success) }     | /student/remove/{id}            |
